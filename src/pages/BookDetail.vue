...
<template>
    <div class="book-detail-page justify-center">
        <div class="page-main space-between">
            <div class="left">
                <div class="book-info flex">
                    ...
                    <div class="right">
                        ...
                        <div class="action-box flex">
                            ...
                            <Button class="action-add_cart" buttonStyle="line">立即下单</Button>
                            <Button class="action-collect" buttonStyle="line">
                                <SvgIcon :name="`star-line`" class="icon star-line" />
                                <span>收藏</span>
                            </Button>
                        </div>
                    </div>
                            ...
                            <div class="tab-content stock-info">
                                ...
                                <div class="stock-info-lib">
                                    <div class="header space-between align-center">
                                        <span>衢州市图书馆(4)</span>
                                        <SvgIcon name="icon-up" class="icon" />
                                    </div>
...
.relate-book-list {
    ...
    .book-item {
        ...
        &:deep(.book-name), &:deep(.book-author) {
            width:133px;
            margin-bottom: 6px;
        }
    }
